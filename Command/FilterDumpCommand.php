 ...
 * @author gerardtoko
 */
class FilterDumpCommand extends ContainerAwareCommand
{
    ...
    {
        $this->setName('gt:imagine:dump:filter')
                ->setDescription('Apply a filter on images group')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $imagine->filterAll($filterArgument, true);
