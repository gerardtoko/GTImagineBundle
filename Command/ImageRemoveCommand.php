 ...
 * @author gerardtoko
 */
class ImageRemoveCommand extends ContainerAwareCommand
{
    ...
    {
        $this->setName('gt:imagine:remove:image')
                ->setDescription('remove an image filtered')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $imagine->removeFilteredImage($imageArgument, $filterArgument);
